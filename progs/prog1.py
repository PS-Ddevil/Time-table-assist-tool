...
Label(master,width=14,height=2, text='8:00 - 8:50', relief="solid",bg='white').grid(row=0,column=1)
Label(master,width=14,height=2, text='9:00 - 9:50', relief="solid",bg='pink').grid(row=0,column=2)
...
Label(master,width=14,height=2, text='4:00 - 4:50', relief="solid",bg='white').grid(row=0,column=9)
Label(master,width=14,height=2, text='Monday', relief="solid",bg='orange').grid(row=1)
