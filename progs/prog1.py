...
from progs.func.save import save_in_excel_sheet 
from progs.func.undo import undo_in_excel_sheet
from progs.func.initialize_excel_files import slot
...
def TimeTable():
	...
	button = Button(master, text='Save',activeforeground='blue',activebackground='red', command=lambda: save_in_excel_sheet(old_var))
